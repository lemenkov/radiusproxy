...
sip_reply_to_h323_err(400) -> 16#7f; %'Interworking, unspecified'
sip_reply_to_h323_err(401) -> 16#39; %'Bearer capability not authorized'
sip_reply_to_h323_err(402) -> 16#15; %'Call rejected'
sip_reply_to_h323_err(403) -> 16#39; %'Bearer capability not authorized'
sip_reply_to_h323_err(404) -> 16#1; % 'Unallocated number'
sip_reply_to_h323_err(405) -> 16#7f; %'Interworking, unspecified'
sip_reply_to_h323_err(406) -> 16#7f; %'Interworking, unspecified'
sip_reply_to_h323_err(407) -> 16#15; %'Call rejected'
sip_reply_to_h323_err(408) -> 16#66; %'Recover on Expires timeout'
sip_reply_to_h323_err(409) -> 16#29; %'Temporary failure'
sip_reply_to_h323_err(410) -> 16#1; % 'Unallocated number'
sip_reply_to_h323_err(411) -> 16#7f; %'Interworking, unspecified'
sip_reply_to_h323_err(413) -> 16#7f; %'Interworking, unspecified'
sip_reply_to_h323_err(414) -> 16#7f; %'Interworking, unspecified'
sip_reply_to_h323_err(415) -> 16#4f; %'Service or option not implemented'
sip_reply_to_h323_err(420) -> 16#7f; %'Interworking, unspecified'
sip_reply_to_h323_err(480) -> 16#12; %'No user response'
sip_reply_to_h323_err(481) -> 16#7f; %'Interworking, unspecified'
sip_reply_to_h323_err(482) -> 16#7f; %'Interworking, unspecified'
sip_reply_to_h323_err(483) -> 16#7f; %'Interworking, unspecified'
sip_reply_to_h323_err(484) -> 16#1c; %'Address incomplete'
sip_reply_to_h323_err(485) -> 16#1; % 'Unallocated number'
sip_reply_to_h323_err(486) -> 16#11; %'User busy'
sip_reply_to_h323_err(487) -> 16#12; %'No user responding'
sip_reply_to_h323_err(488) -> 16#7f; %'Interworking, unspecified'
sip_reply_to_h323_err(500) -> 16#29; %'Temporary failure'
sip_reply_to_h323_err(501) -> 16#4f; %'Service or option not implemented'
sip_reply_to_h323_err(502) -> 16#26; %'Network out of order'
sip_reply_to_h323_err(503) -> 16#3f; %'Service or option unavailable'
sip_reply_to_h323_err(504) -> 16#66; %'Recover on Expires timeout'
sip_reply_to_h323_err(505) -> 16#7f; %'Interworking, unspecified'
sip_reply_to_h323_err(580) -> 16#2f; %'Resource unavailable, unspecified'
sip_reply_to_h323_err(600) -> 16#11; %'User busy'
sip_reply_to_h323_err(603) -> 16#15; %'Call rejected'
sip_reply_to_h323_err(604) -> 16#1; % 'Unallocated number'
sip_reply_to_h323_err(606) -> 16#3a; %'Bearer capability not presently available'
